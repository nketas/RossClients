...
outerloop:
           ...
           if (doingGet) {
               ...
               makeEntry(db, Byte.toString(buf[8]), Byte.toString(buf[12]));
           }
       } finally {
           s.close();
       }
   ...
   private void makeEntry(Connection db, String t, String m)
   {
	   String insertQuery = "insert into merchant_transactions values('" + t +"', '" + m + "')";
	   System.out.println("DB entry being made");
	   try {
		db.prepareStatement(insertQuery).execute();
